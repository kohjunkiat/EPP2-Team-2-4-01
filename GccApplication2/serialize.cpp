...
/* Data size is 4 + 128 + 4 + 1 +16 = 152 bytes. We pad to 140 bytes as this is the nearest divisible by 4 we have. So 
	 we add 3 bytes */
...
static TResult assemble(char *outputBuffer, const unsigned char *inputBuffer, int len)
{
...
TResult deserialize(const unsigned char *buffer, int len, void *output)
{
